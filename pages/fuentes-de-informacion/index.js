      ...
      <main className="flex flex-col font-muli">
        <div className="flex-grow p-4 m-4">
          ...
          <p className="text-justify">
            Con el objetivo de “mapear” atendiendo a los intereses y necesidades
            del territorio, se utilizaron fuentes primarias. Las mismas fueron
            obtenidas en reuniones, encuentros con propuestas de dinámicas de
            trabajo en equipos y entrevistas con diversos actores que trabajan
            en diferentes espacios de la ciudad de Paraná. Asimismo, se
            relevaron fuentes secundarias a partir de la información pública de
            organismos estatales y entidades privadas, que se detallan a
            continuación:
          </p>
          ...
          <div className="grid lg:grid-cols-3 gap-12 mt-6 mr-8">
            ...
            <Card
              title="Consejo Provincial del Niño, el Adolescente y la Familia"
              outLink="https://www.entrerios.gov.ar/copnaf/"
            >
              <InfoIcon />
            </Card>
          </div>
